...
//         echo  $this->db->last_query();die;
    ...
    public function get_driver_info($loginOwnerId) { 
        $this->db->select('*') 
                ->from('users u')
    ...
    public function getDriverViewData($driver_id) { 
        $this->db->select('u.*,o.Name as OwnerName,d.License_Number,d.license_front_image,d.license_back_image,d.Status as dl_status,vt.*,v.*,vs.v_d_s_dimension_size,vc.v_l_c_load_capacity') 
                ->from('users u')

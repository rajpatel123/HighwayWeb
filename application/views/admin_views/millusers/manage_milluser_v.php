...
<!--                                <th>Address</th> 
                        ...
                        <tbody>
                            <?php $sl = 1; ?>
                            <?php foreach ($milluser_info as $user_data) { ?>
                                <?php $memberObj = $this->session->userdata; ?>
                            <tr>
                                    <td><?php echo $sl++; ?></td>
                                    <td><img src="<?php echo base_url() ?>/assets/backend/img/milluser/<?php echo $user_data['Image'] ?>" style="width: 20px;height: 20px;"></td>
...
<!--                                    <td><?php // echo $user_data['Address']; ?></td>
                                    ...
                                    <td>
                                        ...
                                        if ($status == 1) {
                                            echo "<a href='" . base_url('admin/milluser/unpublished_milluser/' . $user_data['Id'] . '') . "' class='btn btn-block btn-success btn-xs' data-toggle='tooltip' title='Click to inactive'><i class='fa fa-arrow-down'></i> Active</a>";
                                        } else {
                                            echo "<a href='" . base_url('admin/milluser/published_milluser/' . $user_data['Id'] . '') . "' class='btn btn-block btn-warning btn-xs' data-toggle='tooltip' title='Click to active'><i class='fa fa-arrow-up'></i> Inactive</a>";
                                        }
                                        ?>
                                        </td>
                                        <td>

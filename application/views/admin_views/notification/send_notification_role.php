...
<section class="content">
    <div class="box box-success">
        ...
        <!-- form start -->
        <form role="form" name="add_form" action="<?php echo base_url('admin/notification/create_notification/' . $roleId . ''); ?>" method="post"  class="form-validation" enctype="multipart/form-data">
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12" style="margin-top: 25px;">
                    <table id="example2" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $sl = 1; ?>
                            <?php foreach ($all_user as $notification) { ?>

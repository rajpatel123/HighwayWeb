...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('owner/assignVehicle'); ?>"><i class="fa fa-cogs"></i> Manage Vehicles Type</a></li>
...
<section class="content">
    <div class="box box-success">
        ...
        <!-- form start -->
        <form role="form" name="add_form" action="<?php echo base_url("owner/assignVehicle/create_assign_vehicle/$driverId"); ?>" method="post"  class="form-validation" >
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                     <div class="col-md-6">
            ...
            <div class="box-footer">
                <a href="<?php echo base_url("owner/assignVehicle/add_assign_vehicle/$driverId"); ?>" class="btn btn-danger" data-toggle="tooltip" title="Go back"><i class="fa fa-remove"></i> Cancel</a>

...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('owner/vehicle/vehicle-type'); ?>"><i class="fa fa-cogs"></i> Manage Vehicle</a></li>
...
<section class="content">
    <div class="box box-success">
        ...
        <!-- form start -->
        <form role="form" name="edit_form" action="<?php echo base_url('owner/vehicleType/update_vehicle_type/' . $user_data[0]['v_t_id'] . ''); ?>" method="post" class="form-validation" >

...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo base_url('owner/dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
                        ...
                        <div class="card gradient-1">
                           ...
                           <div class="card gradient-1"> 
                            <div style="height:20px; color:white; padding: 6px 17px 27px;" class="card-body">
                                 <div class="d-inline-block">
                                     <a href="<?php echo base_url('owner/trip/trip_by_status/1'); ?>"><p> View All<i style="    margin-left: 135px; font-weight: bold;" class="fa fa-angle-right"></i></p></a>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                           ...
                           <div class="card gradient-2"> 
                            <div style="height:20px; color:white; padding: 6px 17px 27px;" class="card-body">
                                 <div class="d-inline-block">
                                     <a href="<?php echo base_url("owner/trip/trip_by_status/2")?>"><p> View All<i style="    margin-left: 135px; font-weight: bold;"  class="fa fa-angle-right"></i></p></a>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                           ...
                           <div class="card gradient-3"> 
                            <div style="height:20px; color:white; padding: 6px 17px 27px;" class="card-body">
                                 <div class="d-inline-block">
                                   <a href="<?php echo base_url('owner/trip/trip_by_status/3')?>"><p> View All<i style="    margin-left: 135px; font-weight: bold;"  class="fa fa-angle-right"></i></p></a>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                           ...
                           <div class="card gradient-4"> 
                            <div style="height:20px; color:white; padding: 6px 17px 27px;" class="card-body">
                                 <div class="d-inline-block">
                                     <a href="<?php echo base_url("owner/trip/trip_by_status/4")?>"><p> View All<i style="    margin-left: 135px; font-weight: bold;"  class="fa fa-angle-right"></i></p></a>
                                </div>
                                ...
                                <tr>
                                    ...
                                    <td><?php 
                                        if($t_data['b_l_t_status']!=4){
                                             echo "<a href='" . base_url('owner/dashboard/view_trip/' . $t_data['t_id'] . '') . "'>View Booking Details</a>";;
                                        } else {

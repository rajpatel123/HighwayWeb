...
<section class="content">
    <div class="box box-success">
        ...
        <!-- form start -->
        <form role="form" name="edit_form" action="<?php echo base_url('owner/trip/update_trip/' . $tripData['t_id'] . ''); ?>" method="post" class="form-validation" >
            ...
            <div class="box-footer">
                <a href="<?php echo base_url('owner/trip'); ?>" class="btn btn-danger" data-toggle="tooltip" title="Go back"><i class="fa fa-remove"></i> Cancel</a>
